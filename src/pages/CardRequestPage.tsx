      ...
      <div className="max-w-2xl mx-auto mt-12 text-center space-y-6 text-slate-200">
        ...
        <div className="pt-8">
          <button 
            ...
            className="px-8 py-3 bg-[#F59E0B] text-[#0B0F17] font-black rounded uppercase tracking-widest border border-[#1E2638] hover:bg-[#FF9500] transition-all"
          >
            Back to Dashboard
          </button>
        </div>
  ...
  return (
    <div className="max-w-3xl mx-auto text-slate-200 space-y-6">
      <div>
        ...
        <p className="text-[#8E9BAE] text-xs">Get a physical card for global ATM withdrawals and point-of-sale payments.</p>
      </div>
        ...
        <div className="p-8">
          <div className="flex items-center gap-6 mb-8">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#F59E0B] font-bold uppercase tracking-wider">Provide your shipping address and contact information.</p>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-3">
              <label className="block text-[10px] font-bold text-[#8E9BAE] uppercase tracking-widest">Card Holder Name</label>
              <input
                type="text"
                disabled
                value={formData.name}
            ...
            <div className="space-y-3">
              <label className="block text-[10px] font-bold text-[#8E9BAE] uppercase tracking-widest">Delivery Address</label>
              <div className="relative">
                <MapPin className="absolute left-3.5 top-5.5 text-[#8E9BAE]" size={18} />
                <textarea
                  required
                  rows={3}
            ...
            <div className="space-y-3">
              <label className="block text-[10px] font-bold text-[#8E9BAE] uppercase tracking-widest">Phone Number</label>
              <div className="relative">
                <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#8E9BAE]" size={18} />
                <input
                  type="tel"
                  required
